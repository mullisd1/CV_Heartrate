...
for (i, rect) in enumerate(rects):
	...
	for i in range(len(shape)):
            mapping = i + 1
            if(mapping == 32 or mapping == 42 or mapping == 49 or mapping == 3):
                cv2.circle(image, (shape[i][0], shape[i][1]), 1, (0, 0, 255), -1)

            elif(mapping == 36 or mapping == 47 or mapping == 55 or mapping == 15):
                cv2.circle(image, (shape[i][0], shape[i][1]), 1, (255, 0, 0), -1)
